...
public class UsbDeviceManager implements ActivityTaskManagerInternal.ScreenObserver {
    ...
    /* Omni add-on: multi USB controller switching for Asus ROG devices */
    ...
    private static final String UDC1_NAME_MATCH =
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_SET_CURRENT_FUNCTIONS:
                    ...
                    if (mUseMultiUsbController && FUNCTION_UDC_SWITCH == functions) {
            ...
            if (mBootCompleted && mCurrentUsbFunctionsReceived && mSystemReady) {
                ...
                if (mUseMultiUsbController) {
                    ...
                    try {
                        ...
                        } else if ("peripheral".equals(usb2mode)
                                && !"a800000.dwc3".equals(controller)) {
                            switchudc = true;
                            SystemProperties.set(USB_CONTROLLER_PROPERTY, "a800000.dwc3");
                        }
                        Slog.i(TAG, "usb1_mode=" + usb1mode + " usb2_mode=" + usb2mode
